...
const Services = () => {
  return (
    <div className="container mx-auto py-20">
      <h3 className="text-[#179800] font-semibold text-2xl pb-5">Services</h3>
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-[#EFEBE3] text-center p-6 rounded-md">
        ...
        <div className="bg-[#EFEBE3] p-6 rounded-md">
          <div className="flex justify-center">
            <Image
              src={ServicesImgTwo}
              alt="service_img"
